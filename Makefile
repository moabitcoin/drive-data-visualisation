dockerimage ?= moabitcoin/blockages-demo
...
run:
	@docker run -it --rm --ipc="host" --network="host" -p 5000:5000 -v $(srcdir)/demo:/usr/src/app/demo -v $(datadir):/data --entrypoint=/bin/bash $(dockerimage)
